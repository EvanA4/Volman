async function setSidePage(hide) {
    ...
    if (hide)
        sidepage.className = "absolute top-0 right-0 w-0 h-[100%] overflow-hidden pt-[50px] transition-all duration-300 bg-opacity-25"
    else
        sidepage.className = "absolute top-0 right-0 w-[50%] h-[100%] overflow-hidden pt-[50px] transition-all duration-300 bg-opacity-25"
}
...
async function magic(volname) {
        ...
        <div>
            <div class="w-full flex flex-col items-center text-white">
                ...
                <div class="flex gap-7">
                    <div class="text-xl bg-neutral-700 p-3 rounded-lg w-[300px]">
                        <p>Total Hours</p>
                ...
                <div class="text-xl bg-neutral-700 p-3 rounded-lg w-[300px] mt-5">
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="p-5 flex flex-col gap-5 w-[30vw] h-[300px] overflow-y-scroll rounded-xl" id="seshsDiv">
                </div>
            </div>
        </div>
    `;
    ...
    for (let i = 0; i < voldata.num_seshs; ++i) {
        let seshHTML = `
            <div class="p-3 bg-neutral-700 rounded-lg">
